...
export default function NavbarPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[var(--background)]">
      {/* Header */}
      <header className="sticky top-0 z-30 border-b border-gray-200/60 bg-[var(--background)] px-4 py-3">
        <Link
          href="/"
      ...
      {/* Main Content */}
      <main className="flex flex-1 flex-col items-center justify-center gap-5 p-6 sm:p-8">
